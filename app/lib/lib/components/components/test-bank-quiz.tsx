...
export default function TestBankQuiz({ questions, courseName }: TestBankQuizProps) {
  ...
  const handleSelectOption = (questionId: string, optionIndex: number) => {
    // منع إعادة الاختيار إذا تمت الإجابة مسبقاً
